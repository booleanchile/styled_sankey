...
var OPACITY = {
  ...
  TYPES = ["Solution", "Function", "Module", "Component"],
  TYPE_COLORS = ["#ffd644", "#30ff2c", "#ee74ff", "#ccff43"],
  TYPE_HIGHLIGHT_COLORS = ["#ffd644", "#30ff2c", "#ee74ff", "#ccff43"],
  LINK_COLOR = "#ede2bb",
  INFLOW_COLOR = "#ffd644",
  OUTFLOW_COLOR = "#6cfff9",
  NODE_WIDTH = 20,
  LABEL_ALWAYS_MIDDLE = false,
