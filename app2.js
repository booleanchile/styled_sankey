...
var OPACITY = {
  ...
  TYPES2 = ["Solution", "Financial_Product", "Function", "Module", "Component", "Interface"],
  TYPE_COLORS2 = ["#ffd644", "#6cfff9", "#30ff2c", "#ee74ff", "#ccff43", "#ff7d63"],
  TYPE_HIGHLIGHT_COLORS2 = ["#ffd644", "#6cfff9", "#30ff2c", "#ee74ff", "#ccff43", "#ff7d63"],
  LINK_COLOR2 = "#bbebe9",
  INFLOW_COLOR2 = "#6cfff9",
  OUTFLOW_COLOR2 = "#6cfff9",
  NODE_WIDTH = 40,
...
colorScale = d3.scale.ordinal().domain(TYPES2).range(TYPE_COLORS2),
highlightColorScale = d3.scale.ordinal().domain(TYPES2).range(TYPE_HIGHLIGHT_COLORS2),
...
tooltip = d3.select("#chart2").append("div").attr("id", "tooltip");
...
function update () {
  ...
  function highlightConnected(g) {
    link.filter(function (d) { return d.source === g; })
      ...
      .style("stroke", OUTFLOW_COLOR2)
      .style("opacity", OPACITY.LINK_DEFAULT);

    link.filter(function (d) { return d.target === g; })
      .style("marker-end", function () { return 'url(#arrowHeadOutlow)'; })
      .style("stroke", INFLOW_COLOR2)
      .style("opacity", OPACITY.LINK_DEFAULT);
  }
  ...
  nodeEnter.append("rect")
    ...
    .attr("height", function (d) { return d.height; })
    .attr("width", biHiSankey.nodeWidth());
  nodeEnter.append("text"); /* Append "text" after "rect" to make sure the text is on top of rect */
  ...
  node.on("mouseenter", function (g) {
    if (!isTransitioning) {
      ...
      d3.select(this).select("rect")
        .style("fill", function (d) {
          d.color = d.netFlow > 0 ? INFLOW_COLOR2 : OUTFLOW_COLOR2;
          return d.color;
        })
        .style("stroke", function (d) {
